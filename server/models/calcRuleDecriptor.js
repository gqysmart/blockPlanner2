...
const calcRuleDescriptorSchema = new Schema({ //统一为ruleformulariptor。包括计算规则，断言规则，等等。
...
const coreProject = { "tracer.ownerTag": 1, name: 1, "tracer.updatedTime": 1, "rule.bases": 1, "rule.formula": 1, "rule.iValue": 1 };
const coveredIndex = { "tracer.ownerTag": 1, name: 1, "tracer.updatedTime": 1, "rule.bases": 1, "rule.formula": 1, "rule.iValue": 1 };
